...
export const metadata: Metadata = {
    ...
    description:
        "Professional barber services in Da Nang - haircut (150,000đ), hot towel shaving (80,000đ), and combo packages. The Black Barbershop Da Nang, An Thuong.",
    openGraph: {
        title: "Barber Services & Pricing | The Black Barbershop Da Nang",
        description:
